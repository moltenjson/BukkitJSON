...
public final class BukkitJSON extends JavaPlugin {
    ...
    public void onEnable() {
        Bukkit.getLogger().info("[BukkitJSON] BukkitJSON successfully loaded!");
    }

    @Override
    public void onDisable() {
        Bukkit.getLogger().info("[BukkitJSON] BukkitJSON successfully disabled!");
    }
}
